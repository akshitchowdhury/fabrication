      ...
      <div className="flex flex-wrap">
        <div className="w-full md:w-1/2">
          <div className="float-left mr-8 mb-4">
            <img src="your-image-url.jpg" alt="Service Image" className="rounded-md shadow-md" />
          </div>
          <p className="text-lg">
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full sm:w-1/2 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="your-image-url.jpg" alt="Service Image" className="w-full h-48 object-cover" />
                <div className="p-4">
