...
const AboutUs = forwardRef((props, ref) => {
  ...
  return (
    <div 
      className="about-block flex flex-col md:flex-row items-center justify-center heading text-3xl md:text-4xl font-bold mb-4 text-center md:text-left mx-auto"
      ref={ref}
          >
      ...
      <div className={`about-image md:w-1/2 relative ${isFlipped ? 'hover-flip' : ''} w-full sm:w-1/2 lg:w-1/2 xl:w-1/2`}>
